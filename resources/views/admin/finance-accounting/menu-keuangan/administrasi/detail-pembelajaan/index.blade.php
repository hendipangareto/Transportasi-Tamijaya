                        ...
                        <form action="">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">PIC</label>
                                        <select name="pic_pembelajaan" class="form-control">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_pembelajaan" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatables table-bordered table-hover"
                                ...
                                <tr>
                                    ...
                                    <th class="w-5p">Dana Diberikan (Rp)</th>
                                    <th class="w-5p">Total Belanja (Rp)</th>
                                    <th class="w-5p">Dana Sisa/Kurang (Rp)</th>
                                    <th class="w-5p">Status Laporan</th>
                                    <th class="w-5p">Cara Pembayaran</th>
                                    <th class="w-15p">Kas/Bank</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div class="badge-circle badge-circle-sm badge-circle-primary pointer mr-1" title="detail">
                                                <a href="{{route('finance-accounting-menu-keuangan-administrasi-detail-pembelajaan-formDetails')}}" class="bx bx-show-alt" style="color: white"></a>
                                            </div>
                                            <div class="badge-circle badge-circle-sm badge-circle-warning pointer mr-1"
                                                 title="edit"
                                                 data-toggle="modal" data-target="#modal-edit-detail-pembelajaan">
