            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Neraca Pasiva
                        </li>
                    </ol>
                </div>
            </div>
...
@section('content')
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-content pt-1">
                    <div class="card-body card-dashboard">
                        <div class="table-responsive" id="show-data-balance-pasiva">
                            <div class="text-center">
                                <div class="spinner-border mr-3 spinner-border text-center" role="balance-pasiva">
        ...
        <div class="col-7 col-md-7">
            <div class="card">
                ...
                <div class="card-content pt-1">
                    <div class="card-body card-dashboard">
                        <div class="table-responsive" id="show-data-account-balance-detail-pasiva">
                            <div class="text-center">
                                <h5 for="">Silahkan Pilih Data Neraca Pasiva</h5>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('admin.finance-accounting.master-data.balance-pasiva.modal')
@endsection
