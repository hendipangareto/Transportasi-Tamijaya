                            ...
                            <div class="col-md-12">
                                <div class="card-header  pb-0  d-flex justify-content-between">
                                    ...
                                    <a href="" class="btn btn-primary mr-1" data-toggle="modal"
                                       data-target="#TambahItem"><i class="bx bx-plus-circle"></i> Tambah
                                        Data</a>
                                </div>
{{--                                <div class="row">--}}
{{--                                    <div class="col-md-6">--}}
...
{{--                                </div>--}}
                                        ...
                                        @forelse ($data as $item)
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex">
                                                        <a href="{{ route('master-logistik-detail-pengajuan-pembelian', $item->id) }}"
        ...
        @include('admin.master-logistik.pengajuan-pembelian.tambah-item')
@endsection
