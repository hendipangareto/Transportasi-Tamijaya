<div class="modal fade text-left" id="TambahPengajuanPembelian" tabindex="-1" role="dialog" aria-labelledby="modal-title" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('master-logistik-tambah-pengajuan-pembelian') }}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Kuantitas" id="kuantitas" name="kuantitas"/>
                                    </div>
                                    <div class="col-md-6 col-12 mb-2">
                                    ...
                                    <div class="col-md-12 col-12 mb-2">
                                        ...
                                        <textarea id="catatan_pembelian" class="form-control bootstrap-maxlength-example" name="catatan_pembelian" rows="3" maxlength="255"></textarea>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="date" class="form-control mb-1" placeholder=" " id="batas_waktu_pembayaran" name="batas_waktu_pembayaran"  min="<?php echo date('Y-m-d'); ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
