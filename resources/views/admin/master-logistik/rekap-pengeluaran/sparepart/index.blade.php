        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between" style="background-color: #6697fa">
                    <h4 class="card-title" style="color: black">LOGBOOK SPAREPART PERJALANAN</h4>
                </div>
                    ...
                    <div class="card-body card-dashboard">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="{{ route('master-logistik-logbook-atk-list-data') }}"
                                                       class="btn btn-danger btn-block mt-1"> <i
                                                            class="bx bx-plus-circle"></i>
                                                        ATK</a>
                                                </div>
                                            </div>
                        ...
                        <div class="table-responsive mt-2" id="show-data-filter-accounting">
                            ...
                            <div class="card-header  pb-0  d-flex justify-content-between">
                                ...
                                <button type="button" class="btn btn-success mr-1"> <i class="bx bx-save"></i> Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
