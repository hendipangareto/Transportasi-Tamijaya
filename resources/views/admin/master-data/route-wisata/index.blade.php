...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-content pt-1">
                    <div class="card-body card-dashboard">
                        <div class="table-responsive" id="show-data-route-wisata">
                            <div class="text-center">
                                <div class="spinner-border mr-3 spinner-border text-center" role="route-wisata">
    ...
    @include('admin.master-data.route-wisata.modal')
@endsection
