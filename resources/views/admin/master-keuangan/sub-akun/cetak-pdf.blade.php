...
<table class="font">
    ...
    @forelse ($SubAkun as $item)
        <tr>
            ...
            <td class="posisi">{{ $item->kode_sub_akun }}</td>
            <td class="posisi">{{ $item->nama_sub_akun }}</td>
            <td class="posisi">{{ $item->akun}}</td>
            <td class="posisi">{{ $item->deskripsi_sub_akun}}</td>
        </tr>
    @empty
        <tr>
            <td colspan="8" class="no-data">Data Sub Akun tidak ditemukan</td>
        </tr>
    @endforelse
    </tbody>
</table>
