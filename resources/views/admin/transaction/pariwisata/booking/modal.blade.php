    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                <h4 class="modal-title" id="modal-title">Jadwal Bus Pariwisata <span id="request-capacity"></span>
                </h4>
                <div class="d-flex justify-content-between">
                    <small id="book-warn-message" class="my-auto"></small>
                    <button type="button" class="btn btn-success px-2" style="display:none;"
                        id="button-book-bus-schedule" data-dismiss="modal" aria-label="Close" onclick="BookSchedulePariwisata()">
...
<div class="modal fade text-left" id="modal-add-new-route" tabindex="-1" role="dialog" aria-labelledby="modal-title"
    aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-title">Form Rute Baru</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
            <form action="javascript:void(0)" id="form-add-new-route" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <select name="" id="" class="form-control">
                                    <option value="">--Silahkan Pilih Origin--</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <select name="" id="" class="form-control">
                                    <option value="">--Silahkan Pilih Destination--</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="" name="route_wisata_estimate">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-block btn-outline-success mt-2"><i class="bx bxs-check-circle ml-2"></i>Tambah Rute</button>
                        </div>
                    </div>
