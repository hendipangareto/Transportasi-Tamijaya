                ...
                {{-- <div class="d-flex-row">
                    ...
                    <div class="input-group mb-1">
                        <div class="input-group-prepend">
                           <select id="type_down_payment" name="type_down_payment" class="form-control" style="width:70px;border-color:#DFE3E7 !important;" onchange="changeTypeDP(this)" >
                                <option value="NOMINAL">Rp</option>
                                <option value="PERCENT">%</option>
                           </select>
                        </div>
                        <input onkeyup="checkValidityTotalDP(this)" type="text" class="form-control" id="total_down_payment" name="total_down_payment">
                    </div>
                </div>
                <button type="button" class="btn btn-success w-100 submit_transaction_reguler" style="display: none" onclick="submitTransaction()">Submit Data</button> --}}
            </div>
