        ...
        <div class="col-xl-3 col-md-4 col-12 pr-2">
            <div class="card invoice-action-wrapper shadow-none border">
                <div class="card-body px-1 py-1">
                    ...
                    <div class="invoice-action-btn my-1">
                        <div class="invoice-action-btn my-1">
                            <button class="btn btn-primary btn-block btn-sm invoice-send-btn" onclick="sendEmail()">
                                <i class="bx bx-send"></i>
                                <span>Kirim</span>
                            </button>
                        </div>
                        <div class="invoice-action-btn my-1">
                            <button class="btn btn-outline-primary btn-block btn-sm invoice-print"
                                onclick="printPDF('purchase-order')">
            ...
            <div class="card invoice-action-wrapper shadow-none border">
                <div class="card-body px-1 py-1">
                    ...
                    <ul class="px-0" style="font-size:11px">
                            ...
                            <li>Pembayaran Rp.
                                ...
                                @if ($payment->status == 'REQUESTED')
                                    <label class="text-warning"
                                        style="font-size:11px">{{ $payment->status }}</label>
